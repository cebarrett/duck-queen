...
const BOSS_MAX_PASSIVE = BOSS_DRAIN - 0.008 // drakes can steady him, but only Q can gain ground
...
const TREATY_MAX_PASSIVE = TREATY_DRAIN - 0.006 // support can steady Boundary's pressure, but only Q can gain ground
